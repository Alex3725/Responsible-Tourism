...
const IT_TO_EN = {
    ...
    "Accesso diretto alla laguna e terrazza privata.": "Direct lagoon access and private terrace.",
    ...
    "Lusso assoluto con scala privata in laguna.": "Absolute luxury with private lagoon steps.",
    ...
    "Privacy e verde, a pochi passi dalla spiaggia.": "Privacy and greenery, a short walk from the beach.",
    ...
    "Prezzi indicativi basati sulla camera selezionata": "Estimated prices based on selected room",
    ...
    "Snorkeling con razze, tour dell'isola, immersioni e spa di lusso.": "Snorkeling with rays, island tours, diving, and luxury spa moments.",
    ...
    "Ogni momento e seguito dal nostro team: trasferimenti, concierge e supporto 24/7.": "Every moment is supported by our team: transfers, concierge, and 24/7 assistance.",
    ...
    "Giorno 3: escursione laguna con picnic su motu": "Day 3: lagoon excursion with motu picnic",
    "Giorno 4: tour dell'isola principale e Mount Otemanu": "Day 4: main island tour and Mount Otemanu",
    "Giorno 5: immersioni, jet ski e crociera al tramonto": "Day 5: diving, jet ski, and sunset cruise",
    "Giorno 6: volo panoramico in elicottero e spa": "Day 6: panoramic helicopter flight and spa",
    "Giorno 7: ultimo bagno, shopping e rientro": "Day 7: final swim, shopping, and return",
    ...
    "Maggio-ottobre, clima secco e soleggiato con temperature intorno ai 28 C.": "May-October, dry and sunny weather with temperatures around 28 C.",
    ...
    "Inviaci le tue preferenze e prepareremo un piano personalizzato.": "Send your preferences and we will prepare a personalized plan.",
...
const replaceMappedText = (map) => {
    ...
    textNodes.forEach((node) => {
        ...
        const leading = (_c = (_b = original.match(/^\s*/)) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : "";
        const trailing = (_e = (_d = original.match(/\s*$/)) === null || _d === void 0 ? void 0 : _d[0]) !== null && _e !== void 0 ? _e : "";
